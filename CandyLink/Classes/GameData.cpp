...
void GAMEDATA::init(){
	...
	setisfirsttimegame(true);
	setispaythiscount(false);
	setisautobegin(false);
}
...
void GAMEDATA::setispay(bool bRet)
{

	UserDefault::getInstance()->setBoolForKey("ispay", bRet);
...
{
	return UserDefault::getInstance()->getBoolForKey("ispay", false);
