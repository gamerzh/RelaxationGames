...
void FieldMan::doSlideTackle() {
    ...
    if(this->belongTeamId == PLAYER_TEAM_ID){
        //加大玩家铲球的距离
        if(GeometryTools::calculateDistance(this->getPosition(),GameStatus::getInstance()->getGameBall()->getPosition())<TACKLE_DISTANCE*2 && random(1,100)<=tacklePercentage*100*1.5){
