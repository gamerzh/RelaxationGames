...
int SystemTime::getDayBymonthandyear(int year, int month)
{
	switch (month)
	{
	case 1:
...
int SystemTime::getDayByyear(int year)
{
	if (year % 4 == 0 && year % 100 != 0 || year % 400 == 0)
	{
		return 366;
...
int SystemTime::getday(int year, int month, int day){
...
long SystemTime::getyearday(int year, int month, int day){
